...
class GPGJsonConnector(BaseConnector):
    ...
    def test_connection(self) -> tuple[bool, str]:
        ...
        try:
            ...
            subject = f"[TEST] SERIMA - GPG-encrypted JSON ({generated_at})"
            content_html = format_html(
                "<p>This is an automated test email generated by SERIMA to verify the GPG-encrypted JSON.</p>"
                "<p><strong>This email can be safely deleted.</strong></p>"
                "<hr>"
                "<p>Observer: {}</p>"
                "<p>Generated at: {}</p>",
            ...
            self._send_encrypted("test.json.gpg", {"event": "ping"}, subject, content_html, recipient)
