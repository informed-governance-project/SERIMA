    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('connector_type', models.CharField(choices=governanceplatform.connectors.registry.connector_type_choices, max_length=32, verbose_name='Type')),
                ...
                ('observer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='connectors', to='governanceplatform.observer', verbose_name='Observer')),
            ],
            options={
